    ...
    <SideBar/>
      <div className="grid grid-cols-1 col-span-12 lg:col-span-10 gap-6 md:grid-cols-3 lg:grid-cols-4  p-4 ">
        <article className="flex flex-col gap-4 rounded-lg border  border-gray-100 bg-white p-6  ">
          ...
          <div>
            <strong className="block text-xl font-medium text-gray-500">
              User Count
            </strong>
            ...
            <p>
              ...
              <span className="text-lg text-gray-500">  450 </span>
            </p>
          </div>
        </article>
        ...
        <article className="flex flex-col  gap-4 rounded-lg border border-gray-100 bg-white p-6 ">
          ...
          <div>
            ...
            <p>
              ...
              <span className="text-xl text-gray-500"> 24 </span>
            </p>
          </div>
        </article>
        <article className="flex flex-col   gap-4 rounded-lg border border-gray-100 bg-white p-6 ">
        ...
        <div className=" bg-white rounded-lg py-8 col-span-full justify-center">
          <div >
          <h1 className="text-2xl font-semibold">User Register Count </h1>
            <Chart
