            ...
            <summary className="flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700">
              <Link to="/auser">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-xl py-10  font-medium"> User </span>
                </div>
              </Link>
            </summary>
          </details>
              ...
              <Link to="/amoderate">
                <div className="flex items-center gap-2">
                  <img
                    ...
                    src={require("../assets/inventory-icon.png")}
                  />
                  <span className="text-xl py-10  font-medium"> Monderator </span>
                </div>
              </Link>
            </summary>
          </details>
      ...
      <div className="sticky inset-x-0 bottom-0 border-t border-gray-100">
        <div className="flex items-center gap-2 bg-white p-4 hover:bg-gray-50">
          <img
            ...
            className="h-10 w-10 text-xl py-10  rounded-full object-cover"
          />
